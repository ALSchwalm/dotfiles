...
awful.screen.connect_for_each_screen(function(s)
    ...
    vicious.register(volwidget, vicious.widgets.volume, volume_format_callback, 3, "Master")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "p",
      function()
        awful.util.spawn("rofi -show run -location 2 -width 100 -theme solarized -matching fuzzy")
      end,
